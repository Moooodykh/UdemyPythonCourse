...
s = 'saAsSDfsdavdfdsdSfsfsd'
print(str.islower(s))

# Problem 4: How many times does the letter 'w' show up in the string below?
string_text = 'saAsSDfsdavwdfdsdwSfsfswd'
print(string_text.count('w'))
...
# Problem 6: Find all elements that are in either set:(which means union/merge the two sets)
